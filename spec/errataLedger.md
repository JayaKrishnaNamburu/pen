...
Source: `spec/wave03EditorCore.md`, "Known Errata (Fix During Implementation)"
...
Source: `spec/wave04TransportsImporters.md`, "Known Errata (Fix During Implementation)"
...
Source: `spec/wave05ReactRendering.md`, "Known Errata (Fix During Implementation)"
...
| # | Summary | Disposition | Notes |
|---|---|---|---|
| 1 | The public agent integration surface should be package-first, not protocol-first | Fixed in spec | Wave 6 now centers `@pen/ai-tools` and `@pen/ai-skills` instead of a bridge package. |
| 2 | Skill artifacts must remain adapters, not a second execution engine | Fixed in spec | `@pen/ai-skills` is documented as a wrapper over `@pen/ai-tools`. |
| 3 | Wave 6 AI streaming exit criterion referenced `ModelAdapter` / `@pen/ai` flows that do not exist until Wave 7 | Fixed in spec | Wave 6 continues to verify the M0 native tool and benchmark pipeline directly; Wave 7 owns model orchestration and AI UI. |

---

## Wave 11 — Apps, Execution & Branching

Source: `spec/wave11AppsExecution.md`, "Known Errata (Fix During Implementation)"
...
**Coverage.** Waves 0, 1, 2, 7, 8, 9, 10, and 12 do not have a "Known Errata" section in their specs. They were reviewed and have no outstanding items requiring ledger tracking. If errata surface during implementation of those waves, they should be added to this ledger.
