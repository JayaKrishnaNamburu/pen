...
- Editor primitives such as `EditorRoot`, `EditorContent`, `EditorBlock`, overlays, selection rects, and field-editor wrappers
- Toolbar, slash-menu, selection-toolbar, search, AI, and multiplayer primitives
...
- Runtime dependencies: `@pen/ai`, `@pen/core`, `@pen/dom`, `@pen/history`, `@pen/multiplayer`, `@pen/schema-default`, `@pen/search`, `@pen/shortcuts`, `@pen/types`
...
- Delegate shared DOM editing behavior to `@pen/dom`
...
- Do not move shared DOM editing behavior out of `@pen/dom` just because React is the primary renderer.
