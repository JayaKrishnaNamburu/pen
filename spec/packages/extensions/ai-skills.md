...
- Runtime dependencies: `@input/pen-ai-autocomplete`, `@input/pen-ai-tools`
...
- Path in workspace: `packages/extensions/ai-skills`
- Spec path mirrors workspace path: `packages/extensions/ai-skills.md`
