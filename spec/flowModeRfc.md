...
The detailed drag-and-drop policy split for structured versus flow presentations is defined in `spec/blockDragAndDropRfc.md`.
...
## B. `spec/crossBlockSelectionRfc.md`
...
## C. `spec/wave05ReactRendering.md`
...
The detailed drag-handle and headless custom-handle architecture is further specified in `spec/blockDragAndDropRfc.md`.

## D. `spec/wave03EditorCore.md`
