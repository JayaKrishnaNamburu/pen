...
Posture totality is claimed by walking the product of the resolver's inputs — five generation states against four session shapes against both suggestion states, forty combinations — and asserting every one lands on a declared posture, plus a lifecycle pass showing in-flight renders preview text, awaiting-review renders staged decorations, and accept leaves no review decoration behind.
