	...
	const aiSuggestionActionItems = [
		{
			...
			disabled: !aiSuggestions.controller || aiSuggestions.settings.enabled === false,
		},
		{
			label: "Apply active",
			onClick: () => {
					...
					<div className="inspector-controls">
						...
						<label className="inspector-range-row">
							...
							<input
								...
								onChange={(event) =>
									onAISuggestionsDebounceChange(Number(event.target.value))
								}
							/>
						</label>
						<label className="inspector-range-row">
						...
						<label className="inspector-range-row">
							...
							<input
								...
								onChange={(event) =>
									onAISuggestionsMinStableMsChange(Number(event.target.value))
								}
							/>
						</label>
						<label className="inspector-range-row">
							...
							<input
								...
								onChange={(event) =>
									onAISuggestionsCooldownMsChange(Number(event.target.value))
								}
							/>
						</label>
						<label className="inspector-range-row">
						...
						<label className="inspector-range-row">
							...
							<input
								...
								max={6}
								step={1}
								value={aiSuggestionsSettings.maxSuggestionsPerScope ?? 1}
								onChange={(event) =>
									onAISuggestionsMaxSuggestionsPerScopeChange(
										Number(event.target.value),
									)
