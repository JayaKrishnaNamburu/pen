...
export function NumberedListItemRenderer(
  ...
  // Per spec errata #9: synthetic counter tracking.
  // Pen uses a flat model (no <ol> wrapper), so we walk backward through
  // siblings to compute the counter value. The counter resets when a
  // non-numbered-list block is encountered at the same indent level.
