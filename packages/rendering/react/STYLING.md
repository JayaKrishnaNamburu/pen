...
| `--pen-ai-review-preview-new-animation` | `none` | Streaming-preview “new” animation. |
...
| `pen-block-suggestion` | Autocomplete preview block. |
...
Decoration classes from `@input/pen-ai` / `@input/pen-ai-suggestions` that land in this tree (not assigned as React `className` in this package): `pen-ai-suggestion-animated`, `pen-suggestion-insert`, `pen-suggestion-delete`, `pen-suggestion-final-text-change`, `pen-ai-review-insert`, `pen-ai-review-delete`, `pen-ai-review-context`, `pen-ai-affected-range`, `pen-ai-review-preview-original`, `pen-block-suggestion-delete-block`.
...
| `data-pen-ai-structured-target-preview` | Structured-target preview. |
| `data-pen-ai-structured-virtual-target` | Structured virtual target. |
