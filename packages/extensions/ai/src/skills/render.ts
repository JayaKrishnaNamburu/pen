...
/**
 * Renders one skill's `SKILL.md` body.
 *
...
/**
 * Renders `SKILL.md` plus any scripts and references for one skill.
 *
 * @remarks Pen never writes these files. The host persists or serves the returned list.
 */
export function renderSkillFiles(
	skill: AISkillDefinition,
): readonly AISkillFile[] {
	return [
		{
