...
export class HistoryControllerImpl implements SnapshotsController {
	private editor;
	...
	readonly resolveAuthor: ResolveSnapshotAuthor | undefined;
	private state: SnapshotsState = {
		snapshots: [],
		isRestoring: false,
	};
	...
	private setState(state: SnapshotsState): void {
		this.state = state;
