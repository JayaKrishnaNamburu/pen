...
| Export                                                                                                                                   | Role                                                                                                                                                                                                |
| ---------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `blocksToOps`                                                                                                                            | Pending blocks → insert/update ops. Implemented in core; this package re-exports it. Direct callers: import-markdown, paste (`@input/pen-dom`), autocomplete. import-html consumes the core export. |
...
| `createImportResult`                                                                                                                     | Builds an `ImportResult` drop report. Implemented in core; this package re-exports it. Used by export-json.                                                                                         |
...
| `reportPendingBlockImportViolations`                                                                                                     | Emits `PEN_PROFILE_002` and `PEN_IMPORT_001`. Implemented in core; this package re-exports it. Used by export-json, paste, and write-ops.                                                           |
