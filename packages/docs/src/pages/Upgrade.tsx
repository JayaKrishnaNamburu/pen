	...
	return (
		<>
			...
			<p>
				...
				repository root yet. The current record is{" "}
				<code>spec/MIGRATION.md</code>. It is an engineering record, not
				a 2.0 cut, and it marks each item landed or not-yet.
			</p>
