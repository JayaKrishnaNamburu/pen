...
Add the `edit_document` tool channel as the durable AI edit path (`spec-better-ai/01-edit-channel.md`, EC1–EC13), a replacement for the `<pen-fast-apply>` XML contract.
